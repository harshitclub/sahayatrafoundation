...
import aboutImg from "@/media/aboutSec/aboutSecImage.jpg";
...
export default function AboutSection() {
  return (
    <section
      className="aboutSection w-full py-12 md:py-20 flex items-center justify-center"
      ...
      <div className="aboutSectionContainer maxWidth width90 px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="aboutText">
            ...
            {/* Values list */}
            <div className="mt-6">
              <h3 className="sr-only">Our Core Values</h3>
          ...
          <div className="aboutImage flex items-center justify-center">
            <div className="w-full max-w-md mx-auto rounded-2xl overflow-hidden shadow-lg">
              <Image
                src={aboutImg}
                alt="Saha Yatra Foundation team engaging in community, education, and empowerment activities"
                width={900}
                height={700}
